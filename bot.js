...
const botSay = (data) => {
  return [
    "Perkenalkan nama saya alif bot. siapa nama kamu?",
...
function finishing() {
  pertanyaan.innerHTML = `Thank u ya ${usersData[0]} udah main ke alif bot 😉, kali-kali kita nongki bareng lah ${usersData[2]} bareng ya!`
